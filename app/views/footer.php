            ...
            <div class="bg_in">
               ...
               <!-- <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a target="_blank"  href="https://www.facebook.com/mi.xu2001/" class="fb"><img height="24" width="28" src="<?php echo BASE_URL ?>/public/images/fb.png">Facebook</a></li>
                           <li><a target="_blank" href="https://www.youtube.com/channel/UCiX9gu20qg1mUwQq5vKpSZg" class="fb"><img height="28" width="28" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline: 760-696-3480 </span>
                                    <span class="text_small">(Từ 8h đến 23h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
