                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="<?php echo BASE_URL ?>/public/images/banner1.jpg" alt="Siêu khuyến mãi" width="100%">
                        </div>

                        <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/banner2.jpg" alt="Siêu khuyến mãi" width="100%">
                        </div>

                        <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/banner3.jpg" alt="Siêu khuyến mãi" width="100%">
                        </div>

                         <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/banner4.png" alt="Siêu khuyến mãi" width="100%">
                        </div>
                    </div>
